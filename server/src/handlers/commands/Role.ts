import { ApplicationCommandDataResolvable, Collection, CommandInteraction, GuildChannel, GuildMember, Role, Snowflake } from "discord.js";
...
export class RoleCommand implements IHandler {
